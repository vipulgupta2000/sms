...
}elseif($_SESSION['SESS_perm']=='admin' && $row['style']==0)
$a = $a."<li><a class=\"menu_left\" href=\"home.php?page=".$row['name']."\">".$row['alias']."</a></li>";
}
}
$sql1="select tblid,name,alias,style,groupname from config c,access a where c.name=a.page_name";
...
{
if(($row1['groupname']==$_SESSION['SESS_perm'])&& $row1['style']==0)
