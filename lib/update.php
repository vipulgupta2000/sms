...
function input_new($tbl,$qual,$arr,$arr_show,$mode=1)
{
	$sql1=dbsql($tbl);
...
if($mode>=2)
	...
	//only get pages if this is main table
	if($_GET['page']==$tbl)
$z="<button class=\"btn btn-default\" id=\"btn\" type=\"submit\" name=\"update\" >Update</button></div>";
if($_SESSION['SESS_perm']=='admin')
$z="<div class=\"navbar navbar-default\" role=\"navigation\"><div class=\"col-md-2\"><button class=\"btn btn-danger\" id=\"btn_del\" type=\"submit\" name=\"delete\">Delete</button>.$z";
$a=$z."</div>".$a.$z."</div>";
//$a=$a."&nbsp<input class=\"btn btn-danger\" id=\"btn\" type=\"submit\" name=\"update\" value=\"Update\">";
return $a;
}
